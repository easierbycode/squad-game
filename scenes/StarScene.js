...
import { Octopus } from "../sprites/octopus.js";
...
export class StarScene extends Phaser.Scene {
    ...
    preload() {
        if (location.host == 'easierbycode.github.io') {
            this.load.setBaseURL('/squad-game/');
        }
        ...
        // this.load.image( 'rudy', '../assets/images/rudy.png' )
    ...
    create() {
        ...
        // create a grid of 7 enemies spaced evenly
        // for (var i = 0; i < 7; i++) {
        //     let y = -50;
        //     if (i % 2 == 0)  y = -98;

        //     let o = new Octopus(this, 30 + (i * 50), y);
